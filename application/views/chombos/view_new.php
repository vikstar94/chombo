			...
			<div class="col-md-4 mgbt-xs-20 mgbt-md-0">
				<div class="panel widget light-widget">
					...
					<div class="panel-body-list pd-25">
						<h2 class="mgtp--5"> <span class="font-semibold">Humidity</span> Chart </h2>
						<div id="humidity-placeholder" class="line-placeholder" style="height:318px;"></div>
					</div>
				</div>
			</div>
			<div class="col-md-4 mgbt-xs-20 mgbt-md-0">
				<div class="panel widget light-widget">
					...
					<div class="panel-body-list pd-25">
						<h2 class="mgtp--5"> <span class="font-semibold">Light</span> Chart </h2>
						<div id="light-placeholder" class="line-placeholder" style="height:318px;"></div>
					</div>
				</div>
			</div>
			<div class="col-md-4 mgbt-xs-20 mgbt-md-0">
				<div class="panel widget light-widget">
					...
					<div class="panel-body-list pd-25">
						<h2 class="mgtp--5"> <span class="font-semibold">Polution</span> Chart </h2>
						<div id="polution-placeholder" class="line-placeholder" style="height:318px;"></div>
					</div>
				</div>
			</div>
		</div>
